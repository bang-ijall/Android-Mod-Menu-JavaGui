...
void *hack_thread(void *) {
    ...
    // Offset Hook example
    //DobbyHookFunction((void *) getAbsoluteAddress(targetLibName, string2Offset(OBFUSCATE_KEY("0x123456", 23479432523588))), (void *) get_BoolExample,
    ...
    // Offset Hook example
    //DobbyHookFunction((void *) getAbsoluteAddress(targetLibName,
